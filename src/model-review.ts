...
export const DOCKERCOMPOSE_MODEL_PROMPT = `You are reviewing Docker Compose files for privilege, host access, image reproducibility, and secret exposure.
...
export const DOCKERCOMPOSE_MODEL_SCHEMA: Record<string, unknown> = {
  type: "object",
...
export async function runModelDockerComposeReview(
  ctx: RuleContext,
  detections: DetectionInput[],
  sources: SourceInput[],
...
async function applyModelDockerComposeReview(
  ctx: RuleContext,
